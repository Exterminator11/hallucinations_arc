...
file = "/Users/rachitdas/Desktop/hallucinations_arc/Embedding_analysis/meta-llama_Llama-3.1-8B-Instruct_all_layers_with_embeddings.pt"  # updated file
...
def evaluate_responses():
    ...
    save_path = f"{re.sub(r'[/]', '_', MODEL_NAME)}_hallucination_labels_embeddings.pt"
