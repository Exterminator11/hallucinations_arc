...
def get_research_data(question):
    ...
    print(f'This is the length of the prompt: {prompt_len}')
    gen_tokens = outputs.sequences[0][prompt_len:]
    print(f'These are the generated tokens: {gen_tokens}')
    answer = tokenizer.decode(gen_tokens, skip_special_tokens=True)
    print(f'This is the generated answer: {answer}')
...
if __name__ == "__main__":
    ...
    answer, layers_data = get_research_data(question)
    print(layers_data)
